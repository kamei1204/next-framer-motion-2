...
const Nav = () => {
  ...
  return(
      ...
      <nav className='flex flex-col items-center xl:justify-center  gap-y-4 fixed w-full xl:w-16 xl:max-w-md xl:h-screen h-max top-0 bottom-0 mt-auto xl:right-[2%]  z-50'>
        <div className='flex w-full xl:flex-col items-center justify-between xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[60px] xl:h-max py-6 bg-white/10  text-3xl xl:text-xl xl:rounded-full' >
